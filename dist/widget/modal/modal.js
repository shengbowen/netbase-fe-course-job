  ...
  extend(Modal.prototype, {
    ...
    setContent: function(content){
      ...
      while(this.body.lastChild){
        this.body.removeChild(this.body.lastChild); //innerHTML变化前，删除this.body的子元素，防止下面情况导致的bug
      }

      //支持两种字符串结构和DOM节点
      if(content.nodeType === 1){ 

        this.body.innerHTML = ""; //在ie系列下，直接置空或替换innerhtml会导致 子节点的所有后代元素之间联系被解除，直接导致引用子节点的变量的后代都没有了
    ...
    _initEvent: function(){
      ...
      // )
      util.addEvent(this.container.querySelector('.close'),
